...
- **`allowMissingDefaultMessages`**: Whether to extract message declarations that are missing `defaultMessage` (if true, will be set to same value as `id`). Defaults to: `false`.
